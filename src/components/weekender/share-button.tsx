...
export function ShareButton({
  ...
  async function handleShare() {
    const url = `${window.location.origin}/weekender?persona=${slug}&tier=${tier}`;
    const text = `${title} — ${profile}. Budget ${budget}, ${stopsCount} vetted stops (${tier} tier) this week on OffDays.`;
